...
public class Barang extends javax.swing.JFrame {
    ...
    private void txtSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSimpanActionPerformed
        ...
        try {
            ...
            String kodeBarang = JOptionPane.showInputDialog(null, "Masukkaan Kode");
            String query = "SELECT * FROM barang WHERE kd_brg = '" + kodeBarang + "'";
            rs = stmt.executeQuery(query);
            // Jika kode barang sudah ada, maka akan menampilkan pesan : "Kode barang sudah digunakna"
            if (rs.next()) {
    ...
    public void insert(String kode, String nama, String satuan, int stok_brg, int stok_min){
        try {
            Class.forName(JDBC_DRIVER);
    ...
    public void update(String kode, String nama, String satuan, int stok_brg, int stok_min){
        try {
            Class.forName(JDBC_DRIVER);
